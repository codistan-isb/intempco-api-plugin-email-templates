          ...
          <td align="center" style="padding: 120px 10px" class="main-cell">
            ...
            >
              ...
              <tr>
                <td>
                  <p>
                    To verify your identity and reset your password please enter
                    the OTP code below on the Intempco website. This OTP is a
                    6-digit code that will be valid for 15 minutes only.
                  </p>
                </td>
              </tr>
              <tr>
                <td>
                  <p style="background-color: #f36f21; padding: 15px 0; color: #fff; letter-spacing: 10px; font-size: 30px; border-radius: 10px;">
                    {{confirmationUrl}}
                  </p>
                </td>
              </tr>
