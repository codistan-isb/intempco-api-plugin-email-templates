            ...
            <td align="center" valign="top"><table width="480" class="wrap1001" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="left" valign="top" style="font-family: 'Lato', sans-serif; font-size:13px; line-height:18px; color:#4d4d4d; letter-spacing: -0.5px;">You have been invited to our platform as an Admin.Your credentials are as follow </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                         <td  align="center" valign="middle" style="font-family: 'Source Sans Pro', sans-serif; font-size:24px; font-weight:normal; line-height:18px;"><p><strong>Email:</strong>{{email}}</p></td>
                        <td>&nbsp;</td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                    ...
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                         <td  align="center" valign="middle" style="font-family: 'Source Sans Pro', sans-serif; font-size:24px; font-weight:normal;"><p><strong>Password:</strong>{{password}}</p></td>
                        <td>&nbsp;</td>
                      </tr>
                    </table></td>
                  </tr>
                  ...
                  <tr>
                    <td align="left" valign="top" style="font-family: 'Lato', sans-serif; font-size:13px; line-height:18px; color:#4d4d4d; letter-spacing: -0.5px;">Thanks!<br />The Intempco Team</td>
                  </tr>
                  <!-- End Body -->
                </table></td>
              </tr>
